...
console.log(chalk.gray('latest | OmhcSilence\n'));

// Status
console.log(chalk.white('Status:      ') + chalk.green('Online'));
console.log(chalk.white('Platform:    ') + chalk.gray('Node.js'));
console.log(chalk.white('Timestamp:   ') + chalk.gray(new Date().toISOString()));
console.log(chalk.white('Mode:        ') + chalk.gray('Public\n'));
